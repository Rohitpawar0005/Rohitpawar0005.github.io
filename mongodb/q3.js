...
db.employees.find().sort({name:1}) //sort in asecending order by name
db.employees.find().sort({name:-1}) //sort in descending order by name
...
db.employees.find({location:"FL"},{_id:0, EmpName:"$name"})  //output=> [ { EmpName: 'John Smith' }, { EmpName: 'Mike Joseph' } ]
